...
import manageBudgetImg from '../../../assets/images/budget-page-ss.png';
import reportImg from '../../../assets/images/report-page-ss.png';
import trackExpenseImg from '../../../assets/images/transaction-page-ss.png';
